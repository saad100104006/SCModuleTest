...
public class SCUserObject implements Parcelable {
    ...
    private String userId = null; // string
    ...
    private String grade = null; // string
    ...
    public String getmUserToretanId() {
        return mUserToretanId;
    }

    public void setmUserToretanId(String mUserToretanId) {
        this.mUserToretanId = mUserToretanId;
    }
    ...
    public void setAccess_Token(String application_access_token) {
        this.application_access_token = application_access_token;
    }
    ...
    private String mUserToretanId = null;
    private String application_access_token = null;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(mUserToretanId);
        dest.writeString(application_access_token);
    ...
    public void readFromParcel(Parcel in) {
        ...
        this.mUserToretanId = in.readString();
        this.application_access_token = in.readString();
