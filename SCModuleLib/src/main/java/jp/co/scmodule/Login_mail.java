...
public class Login_mail extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mail = SCSharedPreferencesUtils.getString(Login_mail.this, SCConstants.TAG_EMAIL);
        pass = SCSharedPreferencesUtils.getString(Login_mail.this, SCConstants.TAG_PASSWORD);
...
//            }
    ...
    public void password_reset(View view) {
        startActivity(new Intent(Login_mail.this, PasswordRemainder.class));
...
//                            }
    ...
    private void loadTheUrlAndGetAccessToken(String url, String postdata) {
        ...
        auth_dialog = new Dialog(Login_mail.this);
            ...
            if (json != null) {
                ...
                try {
                    ...
                    if (success.equals("true")) {
                        ...
                        SCSharedPreferencesUtils.putString(Login_mail.this, SCConstants.TAG_EMAIL, mEtEmail.getText().toString());
                        SCSharedPreferencesUtils.putString(Login_mail.this, SCConstants.TAG_PASSWORD, mEtPassword.getText().toString());
                        //save the access and refresh token
                        SCSharedPreferencesUtils.putString(Login_mail.this, SCConstants.TAG_ACCESS_TOKEN, access_token);
                        SCSharedPreferencesUtils.putString(Login_mail.this, SCConstants.TAG_REFRESH_TOKEN, refresh_access_token);
                        ...
                        if (jObj.has("user_data")) {
                            ...
                            if (returnHashMap.containsKey("user_data")) {
                                ...
                                SCSharedPreferencesUtils.putString(Login_mail.this, SCConstants.TAG_APP_ID, userObj.getAppId());
                                SCSharedPreferencesUtils.putString(Login_mail.this, SCConstants.TAG_LOGIN_TYPE, SCConstants.PROVIDER_EMAIL);
...
//                pDialog.dismiss();
                ...
                if (SCGlobalUtils.ishashpass.equals("1")) {
                    SCGlobalUtils.ishashpass = "0";
                    SCSharedPreferencesUtils.removeComponent(Login_mail.this, SCConstants.TAG_PASSWORD);
                }
            }
        }
    }
