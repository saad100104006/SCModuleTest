...
public class PasswordRemainder extends Activity {
    ...
    private void sendForgetPasswordLinkToTHeEmail() {
        ...
        SCRequestAsyncTask requestAsync = new SCRequestAsyncTask(PasswordRemainder.this, SCConstants.REQUEST_PASSWORD_REMINDER, params, new SCRequestAsyncTask.AsyncCallback() {
            ...
            public void done(String result) {
                ...
                try {
                    ...
                    if (jObj.getString("success").equals("true")) {
                        // Toast.makeText(PasswordRemainder.this, jObj.getString("data"), Toast.LENGTH_LONG).show();
                        ...
                        SCGlobalUtils.showInfoDialog(PasswordRemainder.this, title, dialogBody, null, null);
                    } else {
                        //Toast.makeText(PasswordRemainder.this, jObj.getString("error"), Toast.LENGTH_LONG).show();
                        dialogBody = jObj.getString("error");
                        SCGlobalUtils.showInfoDialog(PasswordRemainder.this, null, dialogBody, null, null);
                    }
            ...
            public void progress() {
                SCGlobalUtils.showLoadingProgress(PasswordRemainder.this);
            }
