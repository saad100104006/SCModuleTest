...
public class SCMemberListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        else if (mActivity.getPackageName().equals(SCConstants.PACKAGE_TORETAN_RELEASE) || mActivity.getPackageName().equals(SCConstants.PACKAGE_TORETAN_DEBUG) || mActivity.getPackageName().equals(SCConstants.PACKAGE_TORETAN_STAGING)) {
            holder.mPbMoneyLine.setProgressDrawable(mActivity.getResources().getDrawable(R.drawable.common_pb_horizontal_toretan));
        }
