...
//        mCorrectSize.correctSize();
    ...
    protected void findViewById() {
        ...
        if (getPackageName().equals(SCConstants.PACKAGE_TADACOPY_RELEASE) || getPackageName().equals(SCConstants.PACKAGE_TADACOPY_DEBUG) || getPackageName().equals(SCConstants.PACKAGE_TADACOPY_STAGING)) {
            ...
            mEtEmail.setBackgroundResource(R.drawable.edittextbackground);
            mEtPassword.setBackgroundResource(R.drawable.edittextbackground);
            mEtPasswordConfirm.setBackgroundResource(R.drawable.edittextbackground);
    ...
    private void setUpViewsForToretan() {
        mLoginPage.setBackgroundResource(R.drawable.login_text_new_toretan);
        mBtnRegister.setBackgroundResource(R.drawable.login_mail_toretan);
    }
...
//                            }
    ...
    private void requestRegisterMail() {
        ...
        else if (getPackageName().equals(SCConstants.PACKAGE_TORETAN_RELEASE) || getPackageName().equals(SCConstants.PACKAGE_TORETAN_DEBUG) || getPackageName().equals(SCConstants.PACKAGE_TORETAN_DEBUG)) {
