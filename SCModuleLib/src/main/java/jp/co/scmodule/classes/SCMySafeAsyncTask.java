 ...
 * @param <ResultT>
 */
public abstract class SCMySafeAsyncTask<ResultT> implements Callable<ResultT> {
     ...
     */
    public SCMySafeAsyncTask(Handler handler) {
     ...
     */
    public SCMySafeAsyncTask(Executor executor) {
        this.executor = executor;
    }

    public SCMySafeAsyncTask(Handler handler, Executor executor) {
        this.handler = handler;
        this.executor = executor;
    }
    ...
    public SCMySafeAsyncTask<ResultT> executor(Executor executor) {
        this.executor = executor;
        return this;
    }
    ...
    public SCMySafeAsyncTask<ResultT> handler(Handler handler) {
        this.handler = handler;
        return this;
    }
    ...
    public static class Task<ResultT> implements Callable<Void> {
        protected SCMySafeAsyncTask<ResultT> parent;
        protected Handler handler;

        public Task(SCMySafeAsyncTask<ResultT> parent) {
            this.parent = parent;
