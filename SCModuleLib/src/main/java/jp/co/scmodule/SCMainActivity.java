...
public class SCMainActivity extends SCMyActivity {
    ...
    public static ArrayList<Object> mSCDashBordAddList = null;
...
//                        tv_add_group.setText(groupObject.getGruop_name());
       ...
       ImageView dialog_header = (ImageView) v.findViewById(R.id.dialog_header);
        ...
        if (getPackageName().equals(SCConstants.PACKAGE_TADACOPY_RELEASE) || getPackageName().equals(SCConstants.PACKAGE_TADACOPY_DEBUG) || getPackageName().equals(SCConstants.PACKAGE_TADACOPY_STAGING)) {
           ...
           // dialog_header.setImageResource(R.drawable.sc_dialog_header_canpass);
            ...
            scmain_img_scicon.setBackgroundResource(R.drawable.smart_campus_toretan_selector);
            dialog_header.setImageResource(R.drawable.sc_dialog_header_toretan);
            webpage.setText("");
            webpage.setBackgroundResource(R.drawable.gotowebpage_toretan);
    ...
    private void show_tut_two() {
        ...
        if (getPackageName().equals(SCConstants.PACKAGE_TADACOPY_RELEASE) || getPackageName().equals(SCConstants.PACKAGE_TADACOPY_DEBUG) || getPackageName().equals(SCConstants.PACKAGE_TADACOPY_STAGING)) {
            ...
            dialog_header.setImageResource(R.drawable.point_dialog_header_toretan);
            webpage.setText("");
            webpage.setBackgroundResource(R.drawable.gotowebpage_toretan);
          //  webpage.setBackgroundResource(R.drawable.selector_btn_next_toretan);
    ...
    private void setUpViewsForToretan() {
        mIbtnSCLogo.setBackgroundResource(R.drawable.smart_campus_toretan_selector);
        mIbtnChangePoint.setBackgroundResource(R.drawable.btn_change_point_toretan_selector);
        mPbMoneyLine.setProgressDrawable(getResources().getDrawable(R.drawable.common_pb_horizontal_toretan));
        oceanize_label.setTextColor(getResources().getColor(R.color.toretan_main));
    }
