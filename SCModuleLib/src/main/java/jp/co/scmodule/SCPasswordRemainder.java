...
public class SCPasswordRemainder extends Activity {
    ...
    private void setUpViewsForToretan() {
        sc_change_password.setBackgroundResource(R.drawable.btn_reset_pass_toretan);
    }
    ...
    private void sendForgetPasswordLinkToTHeEmail() {
        ...
        if (getPackageName().equals(SCConstants.PACKAGE_TADACOPY_RELEASE) || getPackageName().equals(SCConstants.PACKAGE_TADACOPY_DEBUG) || getPackageName().equals(SCConstants.PACKAGE_TADACOPY_STAGING)) {
            ...
            params.put(SCConstants.PARAM_APPLICATION_ID, SCConstants.APPLICATION_ID_TORETAN);
        }
