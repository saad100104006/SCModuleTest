 ...
 *
 */
public class SCMultipleScreenToretan {

    private static int SCREEN_WIDTH_SIZE = 640;
    private static float scale = 0f;
    private static Activity mActivity = null;
     ...
     *
     */
    public SCMultipleScreenToretan(Activity activity) {
        mActivity = activity;
        scale = screenScale();
    }
     ...
     *
     */
    public SCMultipleScreenToretan(Context context) {
        mActivity = (Activity) context;
        scale = screenScale();
    }
