...
public class SCLoginActivity extends SCMyActivity {
    private static final String TAG_LOG = "SCLoginActivity";
...
//        }
        Intent intent = new Intent(SCLoginActivity.this,Login_mail.class);
        startActivity(intent);
        //finish();
...
//                    }
                    ...
                    SCSharedPreferencesUtils.putString(SCLoginActivity.this, SCConstants.TAG_EMAIL,  mEtEmail.getText().toString().trim());
                    SCSharedPreferencesUtils.putString(SCLoginActivity.this, SCConstants.TAG_PASSWORD, mEtPassword.getText().toString().trim());
